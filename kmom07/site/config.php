 ...
 * Set database(s).
 */
$ly->config['database'][0]['dsn'] = 'sqlite:' . LYCKA_SITE_PATH . '/data/.ht.sqlite';
 ...
 * Template files can reside in the parent or current theme, the CLycka::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly LYCKA_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
...
$ly->config['theme'] = array(
  ...
  'data' => array(
    ...
    'logo_width'  => 80,
    'logo_height' => 80,
    'footer' => '<p>Lycka &copy; by Anderz Johansson</p>',
  ),
);
