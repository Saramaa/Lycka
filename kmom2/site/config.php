 ...
 * the url 'deveper/dump' would instantiate the controller with the key "deveper", that is 
 * CCDeveper and call the method "dump" in that class. This process is managed in:
 * $->FrontControllerRoute();
 * which is called in the frontcontroller phase from index.php.
 */
$ly->config['controllers'] = array(
  'index'     => array('enabled' => true,'class' => 'CCIndex'),
  'deveper' => array('enabled' => true,'class' => 'CCDeveper'),
);
